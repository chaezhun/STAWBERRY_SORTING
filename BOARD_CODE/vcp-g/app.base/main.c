...
static void Main_StartTask (void * pArg)
{
    ...
    // create the system tasks, including the sorting task
    AppTaskCreate();

    // The LCD is owned entirely by can_vcp_ctrl.
    // The SDK demo was removed: it printed its own banner and re-initialised I2C,
    // which fought with can_vcp_ctrl over the bus.
    while (1) {
